...
<div id="templatemo_main">
			...
			<div class="col one_fourth gallery_box">
                <a href="${p.l_imagepath}" rel="lightbox[portfolio]"><img src="${p.s_imagepath}" class="image_frame"/></a>
                <h5>${p.name}</h5>
                <p>Price : <c:out value="${p.price}"></c:out>   Stock : <c:out value="${p.stock}"></c:out>  <br>MadeBy : <c:out value="${p.madeby}"></c:out></p>
				<button>Buy</button>
			</div>
            </c:forEach>
            
            
            <div class="cleaner"><selec/div>
            <div class="pagging">
                <ul>
